        ...
        <div class="form-group">
          ...
          @foreach ($variations as $variation)
            <div class="form-check form-check-inline">
              <input name="variations[]" class="form-check-input" type="checkbox" id="inlineCheckbox{{$variation->id}}" value="{{$variation->id}}" {{in_array($variation->id, $product->variations->pluck('id')->toArray()) ? "checked" : '' }}>
