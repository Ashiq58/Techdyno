...
<body>
  ...
  <div class="container-fluid">
    <div class="row">
      <nav class="col-md-2 d-none d-md-block bg-light sidebar">
        <div class="sidebar-sticky">
          <ul class="nav flex-column">
            <li class="nav-item">
              <a class="nav-link {{ (request()->is('/')) ? 'active' : '' }}" href="{{route('site.index')}}">
                Home <span class="sr-only">(current)</span>
              </a>
            </li>
            <li class="nav-item ">
              <a class="nav-link {{ (request()->is('variations')) ? 'active' : '' }}" href="{{route('variations')}}">
                Variations
              </a>
            </li>
            <li class="nav-item">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4" id="vueApp">
        @yield('content')
      </main>
    </div>
  </div>
